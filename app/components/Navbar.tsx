...
export default function NavbarSR() {
    ...
    return (
        ...
        <nav className={`fixed top-8 z-500 left-0 right-0 mx-auto max-w-5xl bg-wanderlust border-4 border-feisty flex flex-col sm:flex-row gap-2 items-center px-2 justify-center p-2 rounded -extralight shadow-md shadow-feisty/50`}>
